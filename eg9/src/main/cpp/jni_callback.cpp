...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass clz = env->FindClass("com/sun/eg9/JniCallbackDemo$JniHandler");
    //赋值到结构体
...
Java_com_sun_eg9_JniCallbackDemo_startTiming(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_sun_eg9_JniCallbackDemo_stopTiming(JNIEnv *env, jobject instance) {
    LOGD("jni stopTiming");
